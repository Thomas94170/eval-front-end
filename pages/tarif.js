    ...
    <>
      ...
      <div className='tarif'>
            ...
            <div>
                ...
                <p className=' text-center '>Séance pour une personne, en extérieur ou en studio</p>
            </div>
            <br />
            <div>
                <h2 className=" text-center ">« Pour deux »</h2>
                <p className=" text-center text-info">195 € </p>
                <p className=' text-center '>Pour deux personnes, en extérieur ou en studio</p>
            </div>
            <br />
            <div>
                <h2 className=" text-center ">« Famille »</h2>
                <p className=" text-center text-info">220 € </p>
                <p className=' text-center '>Pour la famille ou les amis jusqu’à 4 personnes, en extérieur ou en studio
            ...
            <div>
                ...
                <p className=' text-center '>Photo de grossesse (À votre domicile, en extérieur ou en studio)</p>
            </div>
            <br />
            <div>
                <h2 className=" text-center ">« Mon bébé »</h2>
                <p className=" text-center text-info">100 € </p>
                <p className=' text-center '>Photo d’enfant jusqu’à 3 ans (photo à domicile)</p>
            </div>
            <br />
            <div>
                <h2 className=" text-center">« J’immortalise l’événement »</h2>
                <p className=" text-center text-info">Sur Devis</p>
                <p className=' text-center '>Prestation de mariage ou baptême sur devis</p>
            </div>
            </div>
